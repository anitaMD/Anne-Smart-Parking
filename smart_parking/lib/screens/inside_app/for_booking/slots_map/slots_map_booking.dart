...
class BookingThroughSlotsMap extends StatefulWidget {
...
class _BookingThroughSlotsMapState extends State<BookingThroughSlotsMap> {
  @override
  void initState() {
    ...
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            ...
            String source =
                snapshot.data!.metadata.hasPendingWrites ? "Local" : "Server";
            ...
            parkingSlotsTotal = insideParkingInfoFetched["Total Slots Number"];
            getAlleySlotsId(parkingSlotsTotal);
            ...
            return Container(
              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  color: const Color.fromARGB(0, 237, 178, 178),
                  width: double.infinity,
                  padding: const EdgeInsets.only(top: 10),
                  child: Column(
                    children: [
                      SizedBox(
                        //---------!!!!DATE SELECTION BY DEFAULT TODAY
                        width: 540,
                        child: firstTimeAskingForDateSelect == true &&
                                isReservationDayPicked == false
                            ? ElevatedButton(
                                onPressed: () => pickDate(),
                            ...
                            : ElevatedButton(
                                onPressed: () => pickDate(),
                                child: FittedBox(
                                  child: isReservationDayPicked == false
                                      ? const Text("NO DATE SELECTED YET")
                                      : Text(
                                          "${reservedDate.year}/${reservedDate.month}/${reservedDate.day}"),
                                ),
                              ),
                      ),
                      const SizedBox(
                      ...
                      ElevatedButton(
                          onPressed: () {}, child: const Text('SELECT TIME')),
                      Column(
                        children: [
                          Row(
                            children: [
...
void drawDashedLeftBorder(Canvas canvas, Size size, Paint paint, int dashWidth,
...
void drawDashedRightBorder(Canvas canvas, Size size, Paint paint, int dashWidth,
    int dashSpace, double paintStartYmax) {
