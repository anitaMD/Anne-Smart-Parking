...
import 'package:smart_parking/old/screens/inside_app/for_dashboard/booking.dart';
import 'package:smart_parking/old/screens/inside_app/for_dashboard/dashboard_home.dart';
import 'package:smart_parking/old/screens/inside_app/for_dashboard/history.dart';
import 'package:smart_parking/old/screens/inside_app/for_dashboard/notifs.dart';
import 'package:smart_parking/old/styling/faded_indexed_stacked.dart';
...
class _DashboardWrapperPageState extends State<DashboardWrapperPage> {
  ...
  Widget getBodyNoEffect() {
    List<Widget> pages = [
      DashboardHomePage(
          ...
          timeUntilResStartsFromBookingOverview:
  ...
  Widget getBodyWFadedEffect() {
    ...
    debugPrint(
        " currentindex $_currentIndex  __ widgetnewindex ${widget.newIndex} _ goB $goBack");
    List<Widget> pages = [
      DashboardHomePage(
          canShowToggle: canShowToggle,
          getIndex: getIndex,
  ...
  void canShowToggle(bool canShow) {
    ...
    return Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: const Color.fromARGB(255, 95, 91, 91).withValues(alpha: 0.4),
          borderRadius: BorderRadius.circular(13),
        ...
        child: Center(
          child: Container(
            ...
            child: ToggleButtons(
              ...
              renderBorder: true,
              selectedBorderColor:
                  const Color.fromARGB(255, 95, 91, 91).withValues(alpha: 0),
              borderColor:
                  const Color.fromARGB(255, 95, 91, 91).withValues(alpha: 0),
  ...
  Draggable<Widget> dragMapDashToggleSwitch() {
      ...
      body: GestureDetector(
        ...
        child: Stack(
            ...
            children: [
              ...
              showToggle == false || isDropped == true
                  ? Container()
