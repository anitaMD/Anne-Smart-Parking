...
import 'package:smart_parking/old/screens/inside_app/for_booking/location_alert_box.dart';
import 'package:smart_parking/old/screens/inside_app/for_booking/for_sliding_up_panel.dart/slider_inf_loaded.dart';
import 'package:smart_parking/old/screens/inside_app/for_booking/refresh_and_slideup.dart';
import 'package:smart_parking/old/screens/inside_app/for_booking/slots_map/no_alert.dart';
...
class BookingPageState extends State<BookingPage> {
  ...
  void initState() {
    ...
    firestoreParkingLocationService.getParkingInfoData().then((themap) {
      ...
      widget.parkingToNavigateTo.isNotEmpty
          ? getPolyPoints()
          : debugPrint('IS VERY EMPTY');
